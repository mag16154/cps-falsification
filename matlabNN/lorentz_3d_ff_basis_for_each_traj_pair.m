...
output_x_plus_v_values = output_mat(1:3,:)+output_mat(4:6,:);
target_x_plus_v_values = target_mat(1:3,:)+target_mat(4:6,:);
...
subplot(3,1,1);
plot(total_output_points(1,1:pts_to_be_plotted), output_x_plus_v_values(1,1:pts_to_be_plotted), total_output_points(1,1:pts_to_be_plotted), target_x_plus_v_values(1,1:pts_to_be_plotted));
subplot(3,1,2);
plot(total_output_points(1,1:pts_to_be_plotted), output_x_plus_v_values(2,1:pts_to_be_plotted), total_output_points(1,1:pts_to_be_plotted), target_x_plus_v_values(2,1:pts_to_be_plotted))
subplot(3,1,3);
plot(total_output_points(1,1:pts_to_be_plotted), output_x_plus_v_values(3,1:pts_to_be_plotted), total_output_points(1,1:pts_to_be_plotted), target_x_plus_v_values(3,1:pts_to_be_plotted))
