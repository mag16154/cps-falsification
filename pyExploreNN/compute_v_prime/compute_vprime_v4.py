...
# Input (x,v,x')
# Output v'
# x is at 0 and x' are taken at consecutive times starting from 1
    ...
    def createNN(self, jump_size=1):
        ...
        for traj_pair in traj_combs:
            ...
            for step in range(1, steps, jump_size):
                ...
                x_v_xp_pair = x_v_xp_pair + list(traj_1[t_val])
        ...
        for traj_pair in traj_combs:
            ...
            for step in range(1, steps, jump_size):
                ...
                x_v_xp_pair = x_v_xp_pair + list(v_val)
                x_v_xp_pair = x_v_xp_pair + list(traj_1[t_val])
                x_test_local.append(x_v_xp_pair)
